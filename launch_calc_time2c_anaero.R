...
launchcalc <- function (anaero, mass, l_profile, forces, glen_end, glen_start, l_angle){
  ...
  if ((launch_height > (glen_end - 0.005)) & (launch_height < (glen_end + 0.005))){   
    ...
    # write.csv(output,(paste0("Outputs/variable_speed/",l_profile,"2/",forces,"_",anaero,"_",l_angle,"_mmc.csv")))
    # write.csv(force,(paste0("Outputs/variable_speed/",l_profile,"2/",forces,"_",anaero,"_",l_angle,"_mmc_working.csv")))
    graphoutput <- data.frame (force$time,force$culmdist)
    write.csv(graphoutput,(paste0("Outputs/variable_speed/",l_profile,"3/",l_angle,"_c_",forces,"_",anaero,"_mm_graph.csv")))
