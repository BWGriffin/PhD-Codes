...
graph.loop <- function(sc, j, df, mass1, mass2, mass3, ti, vary, l1, l2, l3)
  {
##Load and Setup##
  dirname <- "MM/Combined/"
  ...
  buname2 <- (paste0(quname, j,df,mass3))
  biname2 <- (paste0(quname, j,df,mass2))
  quname2 <- (paste0(quname, j,df,mass1))
...
graph.loop (sc = "0_73/", j = "Hip", df = "_ABAD", mass1 = "_m1", mass2 = "_m2", mass3 = "_m3", ti= "Hip Abduction", 
            vary =" mass",l1 = 'Convex Hull', l2 = '3D-VRE', l3 = 'Convex Hull + 3D-VRE')
graph.loop (sc = "0_73/", j = "Hip", df = "_ABAD", mass1 = "_m1", mass2 = "_m1b", mass3 = "_m1c", ti= "Hip Abduction", 
            vary =" fmax average",l1 = 'Crocodilian Average', l2 = 'Avian Average', l3 = 'Overall Average')
